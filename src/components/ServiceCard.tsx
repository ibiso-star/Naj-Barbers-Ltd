...
export function ServiceCard({ service }: { service: Service }) {
  return (
    <Link
      ...
      className="group flex flex-col justify-between rounded-2xl border border-navy/10 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
    >
      <div>
