...
-- (see PRD.md §9 Open Questions).

insert into services (id, name, category, description, duration_minutes, price_gbp, deposit_gbp) values
  (gen_random_uuid(), 'Classic Haircut', 'haircut', 'Precision cut, tailored to your style, finished with a hot towel.', 30, 25, 5),
  (gen_random_uuid(), 'Skin Fade', 'fade', 'Sharp, blended skin fade with clean line-up.', 45, 30, 5),
  (gen_random_uuid(), 'Beard Trim', 'beard', 'Shape and tidy with straight razor line-up.', 15, 12, 0),
  (gen_random_uuid(), 'Hot Towel Shave', 'shave', 'Traditional wet shave with hot towel and finishing balm.', 30, 22, 5),
  (gen_random_uuid(), 'Restyle Consultation', 'restyle', 'Full consultation and restyle for a fresh new look.', 60, 40, 10),
  (gen_random_uuid(), 'Kids'' Cut', 'kids', 'Relaxed, friendly cut for younger clients (under 12).', 20, 15, 0);
